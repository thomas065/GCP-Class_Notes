...
<body><div class="container">
  <div class="column left">
    ...
    <div class="speech-bubble bubble-red bubble-5">You always mess things up, don’t you?</div>
    <div class="speech-bubble bubble-red bubble-7">Maybe this was a sign… a bad one.</div>
    <div class="speech-bubble bubble-red bubble-9">Could I be in another dimension?</div>
  </div>
  <div class="column middle">
    <div class="error-code">GCP</div>
...
<div>Network Tags:&nbsp;$network_tags</div>
  ...
  <div class="column right">
    <div class="speech-bubble bubble-green bubble-2">Relax, it's just a 404. Nothing actually broke.</div>
    <div class="speech-bubble bubble-green bubble-4">Maybe the page just went for a walk?</div>
    <div class="speech-bubble bubble-green bubble-6">Not every wrong turn is a mistake. Some lead to hidden paths.</div>
    <div class="speech-bubble bubble-green bubble-8">404? More like 4-oh-fun! Right? ...Right?</div>
    <div class="speech-bubble bubble-green bubble-10">You can still hit the back button—no reality rifts here.</div>
  </div>
</div>
